...
percetually uniform colour space and used [model-based measures of memory precision](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2588137/) in order to test the _fidelity_ of aphantasic memory representations on top of whether they simply remembered a feature or not. This novel approach should be more sensitive to true visual mental imagery deficits (which may otherwise be compensated for using verbal memory strategies, for example).
